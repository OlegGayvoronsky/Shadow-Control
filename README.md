...
## 📖 Описание
Данный проект основан на [Выпускной квалификационной работе](https://docs.google.com/document/d/1SHz58FlvD4pblfpWjycz8IZb4xBVcMHW/edit?usp=sharing&ouid=110906974356301510727&rtpof=true&sd=true).<br>
...
- **app** - код приложения
- **polygon** — директория, в которой производилась предварительная проверка функционала при разработке системы
